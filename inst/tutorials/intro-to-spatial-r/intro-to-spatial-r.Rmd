...
```{css echo=FALSE}
# to enable saving complete tutorial as pdf
# from https://github.com/rstudio/learnr/issues/465
# saving this in a separate file print.css didn't work locally or on shinyapps because browser couldn't find file 
@media print {
  .topicsContainer,
  .topicActions,
