...
## mapping spatial data objects with tmap 

There are a number of packages for making maps extend what is available from sf.
...
tm_shape(africapitals) +
  ...
  #tm_symbols(col = "blue") #set colour directly
