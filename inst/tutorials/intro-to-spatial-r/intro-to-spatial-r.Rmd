...
If you look at the output from the `head()` command above you should see that each cell in the geometry column contains elements like this 'POINT (7.17 9.18)'. Because the capitals data are points they just have a single coordinate pair representing the longitude and latitude.
