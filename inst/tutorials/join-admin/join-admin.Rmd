...
library(learnr)
#this causes error on shinyapps
...
```{r read_gapminder, exercise = TRUE, exercise.eval = TRUE, exercise.setup = "library_packages"}
...
```{r filter_gapminder, exercise = TRUE, exercise.setup = "library_packages"}
...
Hint `r fa(name = "lightbulb-on")`: you need a comma(,) to add an extra filter, 2007 is a number and doesn't need quotes "".



```{r filter_gapminder_prep, echo = FALSE, exercise.setup = "library_packages"}
...
```{r tmap_data, eval = TRUE, echo = FALSE, message = FALSE, exercise.setup = "library_packages"}
...
```{r read_spatial_data, exercise = TRUE, exercise.eval = TRUE, exercise.setup = "library_packages"}
...
```{r map_plot, exercise = TRUE, exercise.setup = "library_packages"}
...
```{r map_plot_pop_est, exercise = TRUE, exercise.setup = "library_packages"}
...
```{r head_spatial_data, exercise = TRUE, exercise.eval = FALSE, exercise.setup = "library_packages"}
...
```{r check_class, exercise = TRUE, exercise.eval = TRUE, exercise.setup = "library_packages"}
...
```{r check_names, exercise = TRUE, exercise.eval = TRUE, exercise.setup = "library_packages"}
