...
Can you remember how to inspect the first 6 rows of the new data.frame ? Experiemnt in the window below.
...
```{r head_data-hint, exercise = TRUE, exercise.setup = "filter_gapminder_prep"}
