---
title: "A crash course to spatial in R with African data"
...
## tmap to map vector and raster data
...
## tmap to colour polygons according to data values

```{r tmap-colour-polygons, exercise = TRUE, exercise.eval = TRUE, message = FALSE, warning = FALSE}

tm_shape(africountries) +
    tm_polygons("pop_est")
    #try commenting out above line and replacing with this
